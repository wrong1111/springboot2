package com.yucei.admin.manage.dao;
...
public interface UserMapper {
	...
	int insert(com.yucei.admin.manage.pojo.User record);

	int insertSelective(com.yucei.admin.manage.pojo.User record);
	 ...
	 * @return
	 */
	com.yucei.admin.manage.pojo.User findUserByName(String username);
