package com.yucei.admin.manage.service;

import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.yucei.admin.common.base.PageDataResult;
import com.yucei.admin.common.shiro.ShiroRealm;
import com.yucei.admin.common.utils.DateUtil;
import com.yucei.admin.manage.dao.RoleMapper;
import com.yucei.admin.manage.dao.UserMapper;
import com.yucei.admin.manage.dao.UserRoleMapper;
import com.yucei.admin.manage.entity.UserDTO;
import com.yucei.admin.manage.entity.UserRoleDTO;
...
import com.yucei.admin.manage.pojo.UserRoleKey;
...
/**
 * @项目名称：yucei-admin
 * @包名：com.yucei.admin.manage.service
 * @类描述：
 * @创建人：yucei
...
public class UserServiceImpl implements UserService {
    ...
    public String setUser(User user, String roleIds) {
        ...
        if (user.getId() != null) {
            ...
            user.setIsDel(false);
            user.setIsJob(false);
            user.setMcode(user.getUsername());
            // 设置加密密码
            if (StringUtils.isNotBlank(user.getPassword())) {
                user.setPassword(DigestUtils.md5Hex(user.getPassword()));
            } else {
		...
		if (null != existUser && existUser.getMobile().equals(user.getMobile())) {
			...
			if (existUser.getSendTime() != null) {
				...
				if (((endTime - beginTime) < 60000)) {
					logger.debug("发送短信验证码【yucei-adminr-->UserServiceImpl.sendMsg】用户信息=existUser:"
							+ existUser);
