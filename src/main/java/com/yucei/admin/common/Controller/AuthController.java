...
import com.yucei.admin.manage.entity.PermissionVO;
import com.yucei.admin.manage.entity.RoleVO;
import com.yucei.admin.manage.pojo.Permission;
import com.yucei.admin.manage.pojo.Role;
import com.yucei.admin.manage.pojo.RolePermissionKey;
...
public class AuthController {
    ...
    public ModelAndView permList() {
        ...
        try {
            ...
            //wyong edit 2018-10-16 控制功能菜单不在前端展示
    ...
    public List<PermissionVO> getUserPerms() {
        ...
        try {
            List<PermissionVO> pvoa = authService.getUserPerms(existUser.getId());
            if (pvoa != null && !pvoa.isEmpty()) {
                for (PermissionVO vo : pvoa) {
                    if ("1".equalsIgnoreCase(vo.getIstype())) {
                        continue;
                    }
                    pvo.add(vo);
                }
