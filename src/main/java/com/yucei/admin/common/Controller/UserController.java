package com.yucei.admin.common.Controller;

import com.yucei.admin.common.base.IStatusMessage;
import com.yucei.admin.common.base.PageDataResult;
import com.yucei.admin.common.base.ResponseResult;
import com.yucei.admin.common.redis.RedisClientTemplate;
import com.yucei.admin.common.utils.DateUtil;
import com.yucei.admin.common.utils.ValidateUtil;
import com.yucei.admin.manage.entity.UserDTO;
import com.yucei.admin.manage.entity.UserRolesVO;
import com.yucei.admin.manage.entity.UserSearchDTO;
import com.yucei.admin.manage.pojo.Role;
import com.yucei.admin.manage.pojo.User;
import com.yucei.admin.manage.service.AuthService;
import com.yucei.admin.manage.service.UserService;
...
public class UserController {
    ...
    public String setUser(@RequestParam("roleIds") String roleIds, User user) {
        ...
        try {
            ...
            User existUser = (User) SecurityUtils.getSubject().getPrincipal();
            if (null == existUser) {
                logger.debug("设置用户[新增或更新]，结果=您未登录或登录超时，请您登录后再试");
                return "您未登录或登录超时，请您登录后再试";
            }
    ...
    public ResponseResult login(
        ...
        logger.debug("====login==用户登录，请求参数=user:" + user + "，是否记住我：" + rememberMe);
        ResponseResult responseResult = new ResponseResult();
        responseResult.setCode(IStatusMessage.SystemStatus.ERROR.getCode());
        if (null == user) {
            responseResult.setCode(IStatusMessage.SystemStatus.PARAM_ERROR
        ...
        Object passwordRetryCache = redisClientTemplate.get("passwordRetryCache_" + user.getUsername());
        if (null != passwordRetryCache) {
            int retryNum = (Integer) passwordRetryCache;
    ...
    public static void main(String[] args) throws ParseException {
        Date date = DateUtil.parseDate("2018-01-04 20:15:21", "yyyy-MM-dd HH:mm:ss");
        Date date1 = DateUtil.parseDate("2018-01-04 20:11:21", "yyyy-MM-dd HH:mm:ss");
        Date date2 = DateUtil.parseDate("2018-01-04 20:12:21", "yyyy-MM-dd HH:mm:ss");
